...
let interestRate = .05 //percentage written as decimal, allowed to be changed
let accountBalance = 500 // Account balance 
const t = ((72/interestRate.toFixed(2))/ 100); // Formula for rule 72, divided by 100 to switch decimal places. 

const accountBalanceUpdated = accountBalance * 2; //Account balance after the estimated years in t


console.log("At a " + interestRate + "(percentage as a decimal) interest rate, your savings account will be worth " + accountBalanceUpdated + " in " + t + " years.");
